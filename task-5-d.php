...
<img src="img/blok5d.PNG" alt="">
<div class="content">
        <form action="#" method="post">
        <fieldset>
        <legend>Task 5</legend>
        Введите pas1 <input type="text" name="pass1" class="mb-3"></br>
        Введите pas2 <input type="text" name="pass2" class="mb-3"></br>
...
$pass2_1 = (int)($pass2 / 100);
$pass2_23 = $pass2 % 100;
$pass2_2 = (int)($pass2_23 / 10);
$pass2_3 = $pass2_23 % 10;

if ($pass1_2 > 5) {
$pass2Se = $pass2_1.$pass2_2.$pass2_3;
} else {
$pass2Se = $pass2_3.$pass2_1.$pass2_2;
}
